...
python experiments/test_mixed.py --envname Hopper-v1 --t 500 --iters 5 10 15 20 --dagger_mixed 1
python experiments/test_dart_min_var.py --envname Hopper-v1 --t 500 --iters 5 10 15 20 --update 1 7 --partition 450 --reg_penalty 0.3
...
python experiments/test_mixed.py --envname Walker2d-v1 --t 500 --iters 5 10 15 20 --dagger_mixed True
...
python experiments/test_mixed.py --envname HalfCheetah-v1 --t 500 --iters 5 10 15 20 --dagger_mixed True
...
python experiments/test_mixed.py --envname Humanoid-v1 --t 500 --iters 50 100 150 200 --dagger_mixed True
