...
python experiments/test_mixed.py --envname Hopper-v1 --t 500 --iters 5 10 15 20
...
python experiments/test_mixed.py --envname Walker2d-v1 --t 500 --iters 5 10 15 20
...
python experiments/test_mixed.py --envname HalfCheetah-v1 --t 500 --iters 5 10 15 20
...
python experiments/test_mixed.py --envname Humanoid-v1 --t 500 --iters 50 100 150 200
